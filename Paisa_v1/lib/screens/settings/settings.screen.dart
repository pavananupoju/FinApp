...
import 'package:fintracker/screens/settings/api.dart';
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
                      builder: (context) =>
                          ChatScreen()), // Replace with your chatbot page
                );
              },
              leading: CircleAvatar(
                backgroundColor: const Color.fromARGB(255, 240, 213, 220)
                    .withAlpha(90), // Adjust color as needed
                child: const Icon(
                  Icons.chat_bubble_outline, // Icon representing a bot/chat
                ),
              ),
              title: Text('Chat Bot',
                  style: Theme.of(context).textTheme.bodyMedium?.merge(
                      const TextStyle(
                          fontWeight: FontWeight.w500, fontSize: 15))),
              subtitle: Text("Interact with our bot",
                  style: Theme.of(context).textTheme.bodySmall?.apply(
                      color: Colors.grey, overflow: TextOverflow.ellipsis)),
            ),
          ],
